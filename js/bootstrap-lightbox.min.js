 ...
 * ========================= */
	...
	Lightbox.prototype.preloadSize = function(callback)
	{
		...
		preloader.onload = function()
		{
			...
			var tmpH = preloader.height,
				tmpW = preloader.width;
			if (windowWidth > windowHeight) {
				// landscape
				preloader.height = (windowHeight / 100) * 80;
				preloader.width = (preloader.height / tmpH) * preloader.width;
			} else {
				// portrait
				preloader.width = (windowWidth / 100) * 80;
				preloader.height = (preloader.width / tmpW) * preloader.height;
			}
